                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <select name="type" class="form-control">
                            ...
                            <option value="purchases" {{ request('type') == 'purchases' ? 'selected' : '' }}>Purchases</option>
                        </select>
                    </div>
                    <div class="col-md-3">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($transaction->payable_type === 'App\Models\Order' && $transaction->payable)
                                    <a href="{{ route('orders.show', $transaction->payable->id) }}">{{ $transaction->payable->order_number }}</a>
                                    @php
                                    ...
                                    @endphp
                                    <br><small class="text-muted">Total: Rs {{ number_format($order->total_amount, 2) }} | Remaining: Rs {{ number_format($orderRemaining, 2) }}</small>
                                @elseif($transaction->payable)
                                    ...
                                    @endphp
                                    <br><small class="text-muted">Total: Rs {{ number_format($purchaseTotal, 2) }} | Remaining: Rs {{ number_format($purchaseRemaining, 2) }}</small>
                                @else
                                    N/A
                                @endif
                            </td>
