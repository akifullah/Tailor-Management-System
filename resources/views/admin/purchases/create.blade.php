    ...
    <form action="{{ route('purchases.store') }}" method="POST" id="purchaseForm">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-2">
                ...
                <input type="number" name="quantity_meters" id="quantity_meters" class="form-control" min="0.01" step="0.01" required />
            </div>
            <div class="col-md-2">
                <label>Price per Meter *</label>
                <input type="number" name="price_per_meter" id="price_per_meter" class="form-control" min="0" step="0.01" required />
            </div>
            <div class="col-md-2">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-3" id="paid_amount_div" style="display: none;">
                ...
                <input type="number" name="paid_amount" id="paid_amount" class="form-control" min="0.01" step="0.01" />
        ...
        <div class="row mb-3">
            <div class="col-md-6" id="person_reference_div" style="display: none;">
                <label>Person + Reference</label>
                <input type="text" name="person_reference" class="form-control" placeholder="e.g., John Doe - INV-123" />
            </div>
            <div class="col-md-6" id="payment_notes_div" style="display: none;">
