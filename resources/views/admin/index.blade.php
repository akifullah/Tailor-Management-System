                    ...
                    <div class="card-body">
                        <div class="widget-first">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <span
                                    class="badge badge-custom-second text-success bg-success-subtle fw-medium rounded-4 fs-14 me-2">+
                                    12.5%</span>
                            </div>

                            <p class="text-muted fs-14 mb-2">Data obtained for the last 7 days from
                                worldwild overall orders.</p>

                            <div class="row align-items-center">
                                <div class="col">
                                    <div class="progress progress-md mt-0" role="progressbar" aria-valuenow="55"
                    ...
                    <div class="card-body">
                        <div class="widget-first">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <span
                                    class="badge badge-custom-second text-success bg-success-subtle fw-medium rounded-4 fs-13 me-2">+
                                    12.5%</span>
                            </div>

                            <p class="text-muted fs-14 mb-2">Data obtained for the last 7 days from
                                worldwild monthly revenue.</p>
                                ...
                                <div class="">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-fill">
                                            ...
                                            <div class="progress progress-md mt-2" role="progressbar" aria-valuenow="55"
                                                aria-valuemin="0" aria-valuemax="100">
                                                <div class="progress-bar bg-dark opacity-75 progress-bar-striped"
                                                    style="width: 55%"></div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="mt-3">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-fill">
                                            ...
                                            <div class="progress progress-md mt-2" role="progressbar" aria-valuenow="70"
                                                aria-valuemin="0" aria-valuemax="100">
                                                <div class="progress-bar bg-dark opacity-75 progress-bar-striped"
                                                    style="width: 70%"></div>
                                            </div>
                                ...
                                <div class="">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-fill">
                                            ...
                                            <div class="progress progress-md mt-2" role="progressbar" aria-valuenow="41"
                                                aria-valuemin="0" aria-valuemax="100">
                                                <div class="progress-bar bg-dark opacity-75 progress-bar-striped"
                                                    style="width: 41%"></div>
                                            </div>
                                ...
                                <div class="mt-3">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-fill">
                                            ...
                                            <div class="progress progress-md mt-2" role="progressbar" aria-valuenow="80"
                                                aria-valuemin="0" aria-valuemax="100">
                                                <div class="progress-bar bg-dark opacity-75 progress-bar-striped"
                                                    style="width: 80%"></div>
                                            </div>
                ...
                <div class="card overflow-hidden">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-auto">
                                <button class="btn btn-sm bg-light border dropdown-toggle fw-medium" type="button"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">View All<i
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex align-items-center">
                                            <span class="avatar mb-0 position-relative">
                                                <img class="avatar avatar-sm rounded-2 me-3 bg-primary-subtle rounded-circle p-1"
                                                    src="{{ asset('assets/images/products/bag.png') }}"
                                                    alt="product-image" />
                                            </span>
                                ...
                                <tr>
                                    <td class="text-center">
                                        <div class="d-flex align-items-center">
                                            <span class="avatar mb-0 position-relative">
                                                <img class="avatar avatar-sm rounded-2 me-3 bg-primary-subtle rounded-circle p-1"
                                                    src="{{ asset('assets/images/products/watch.png') }}"
                                                    alt="product-image" />
                                            </span>
                                ...
                                <tr>
                                    <td class="text-center">
                                        <div class="d-flex align-items-center">
                                            <span class="avatar mb-0 position-relative">
                                                <img class="avatar avatar-sm rounded-2 me-3 bg-primary-subtle rounded-circle p-1"
                                                    src="{{ asset('assets/images/products/headphone.png') }}"
                                                    alt="product-image" />
                                            </span>
                                ...
                                <tr>
                                    <td class="text-center">
                                        <div class="d-flex align-items-center">
                                            <span class="avatar mb-0 position-relative">
                                                <img class="avatar avatar-sm rounded-2 me-3 bg-primary-subtle rounded-circle p-1"
                                                    src="{{ asset('assets/images/products/leather-jacket.png') }}"
                                                    alt="product-image" />
                                            </span>
                                ...
                                <tr>
                                    <td class="text-center">
                                        <div class="d-flex align-items-center">
                                            <span class="avatar mb-0 position-relative">
                                                <img class="avatar avatar-sm rounded-2 me-3 bg-primary-subtle rounded-circle p-1"
                                                    src="{{ asset('assets/images/products/shoes.png') }}"
                                                    alt="product-image" />
                                            </span>
                        ...
                        <div class="mt-2">
                            <div class="d-flex align-items-center">
                                <div class="flex-fill">
                                    ...
                                    <div class="progress progress-md mt-2" role="progressbar" aria-valuenow="45"
                                        aria-valuemin="0" aria-valuemax="100">
                        ...
                        <div class="mt-2">
                            <div class="d-flex align-items-center">
                                <div class="flex-fill">
                                    ...
                                    <div class="progress progress-md mt-2" role="progressbar" aria-valuenow="25"
                                        aria-valuemin="0" aria-valuemax="100">
                        ...
                        <div class="mt-2">
                            <div class="d-flex align-items-center">
                                <div class="flex-fill">
                                    ...
                                    <div class="progress progress-md mt-2" role="progressbar" aria-valuenow="8"
                                        aria-valuemin="0" aria-valuemax="100">
                            ...
                            <div class="card-toolbar ms-auto">
                                <div class="d-flex flex-stack flex-wrap gap-3">
                                    <div class="d-flex align-items-center fw-bold">
                                        ...
                                        <div class="ms-auto">
                                            <button class="btn btn-sm bg-light-subtle border dropdown-toggle fw-medium"
                                                type="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false">Cateogry<i
                                                    class="mdi mdi-chevron-down ms-1 fs-14"></i></button>
                                            <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <div class="position-relative topbar-search">
                                        <input type="text" class="form-control bg-light-subtle ps-4 py-1 border fs-14"
                                            placeholder="Search...">
                                        <i
                            ...
                            <table class="table table-stock mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-danger-subtle text-danger fw-semibold fs-12">Out
                                                of Stock</span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-warning-subtle text-warning fw-semibold fs-12">Low
                                                Stock</span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-muted">$1487</td>
                                        <td>
                                            <span class="badge bg-primary-subtle text-primary fw-semibold fs-12">In
                                                Stock</span>
                                        </td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-traffic mb-0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a aria-label="anchor" class="btn btn-icon btn-sm bg-primary-subtle me-1"
